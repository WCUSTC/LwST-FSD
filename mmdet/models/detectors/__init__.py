...
from .yolox_VID import YOLOXC3D,YOLOXC3DRes,YOLOXDCNResXFeat,YOLOXTSM_Center,YOLOXDCNNeck, YOLOXTSM_PTA
...
__all__ = [
    ...
    "YOLOXC3D","YOLOXC3DRes",'YOLOXDCNResXFeat','YOLOXTSM_Center',"YOLOXDCNNeck","YOLOXTSM_PTA"
]
