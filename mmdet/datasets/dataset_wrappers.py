...
def show_results(results):
    try:
        cv2.imwrite("img_02.jpg",results["img"])
        cv2.imwrite("img_00.jpg",results["img_0000"])
        cv2.imwrite("img_01.jpg",results["img_0001"])
        cv2.imwrite("img_03.jpg",results["img_0002"])
        cv2.imwrite("img_04.jpg",results["img_0003"])
    except:
        pass
