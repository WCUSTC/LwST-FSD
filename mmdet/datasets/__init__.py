...
from .VID_Dataset_ChongWang import SingleFrameDataset,MultiFrameDataset,MultiFrameDatasetCOCO,MultiFrameDatasetSmoke,MultiFrameDatasetFIgLib
...
__all__ = [
    ...
    'FireSmokeDataset',
    "SingleFrameDataset","MultiFrameDataset","MultiFrameDatasetCOCO","MultiFrameDatasetSmoke","MultiFrameDatasetFIgLib"
]
