...
load_from = r'E:/mmdetection320/work_dir_VIDSmoke/yolox_cspDarknet-s-TSM-PTA68_21-12_cocopretrainedMosaic/epoch_16.pth'
resume = False
work_dir = "E:/mmdetection320/work_dir_VIDSmoke/yolox_cspDarknet-s-TSM-PTA68_21-12_cocopretrainedMosaic"
...
# dataset settings
dataset_type = 'MultiFrameDatasetSmoke'
backend_args = None
...
train_dataset = dict(
    ...
    dataset=dict(
        ...
        annotation_files = [
            r"F:\ShengpingtaiCW\shengpingtai_trainY23M05_correct\shengpingtai_trainY23M05_correct.json",
        ],
        pipeline =[]),
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        related_ids=related_ids,
        annotation_files=[  r"F:\ShengpingtaiCW\shengpingtai_trainY23M05_correct\shengpingtai_trainY23M05_correct.json",],
        test_mode=True,
